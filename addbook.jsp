	...
	<section class="">
		<div class="container">
			...
			<div class="col-md-6">
                ...
                <form method="post"   role="form" action="bookSuccess.jsp">
                  
                <div class="col-md-12 offset_0">
                <div class="col-md-6 offset_0 offset_1">
                    <div class="form-group">
                    <label >Book Name</label>
                    <input type="text" class="form-control" name="bname" placeholder="Enter Book Name" autocomplete="off">
                    </div>
                    ...
                    <input type="text" class="form-control" name="auther" placeholder="Enter Author Name" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="col-md-6 offset_0 offset_1">
                    ...
                    <input type="text" class="form-control" name="quantity" placeholder="Enter Quantity" autocomplete="off">
                    </div>
                    ...
                    <input type="text" class="form-control" name="publisher" placeholder="Enter Publisher Name" autocomplete="off">
                    </div>

                </div>

                <div class="col-md-12 offset_0 offset_1">
                	<button style="width: 100%;" type="submit" name="btnsave" class="btn btn-success">ADD BOOK</button>
                </div>
