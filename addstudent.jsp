    ...
    <body style="background-color: #151515;">
        ...
        <section class="">
            <div class="container">
                ...
                <div class="col-md-6">
                    <form name="Form2" action="addstudent.jsp" method="POST">
                                    ...
                                    <div class="col-md-12 offset_0">
                                        <div class="col-md-6 offset_0 offset_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="#" name="id" placeholder="Enter Student ID" autocomplete="off">
                                            </div>

                                            <div class="form-group">
                                                <label >Email</label>
                                                <input type="text" class="form-control" id="#" name="email" placeholder="student@example.com" autocomplete="off">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label >Select Student Class</label>
                                                 <input type="text" class="form-control" id="#" name="classname" placeholder="Enter Class name" autocomplete="off">
                                        ...
                                        <div class="col-md-6 offset_0 offset_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="#" name="name" placeholder="Enter Student Name" autocomplete="off">
                                            </div>

                                            <div class="form-group">
                                                <label >Password</label>
                                                <input type="password" class="form-control" id="#" name="password" placeholder="Enter Student Name" autocomplete="off">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label >Address</label>
                                                <input type="text" class="form-control" id="#" name="address" placeholder="Enter Student Address" autocomplete="off">
                                            </div>
    ...
    <%
        if (request.getParameter("id") != null) {
            ...
            try {
                ...
                String query = "INSERT INTO student(id,name,email,password,gender,dob,contactNo,stream,class,address)VALUES('" + id + "','" + name + "','" + email + "','" + password + "','" + c + "','" + dob + "','" + contact + "','" + stream + "','" + classname + "','" + address + "')";
