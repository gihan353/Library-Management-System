...
<body style="background-color: #151515;">
 ...
 //out.println("name i9s "+name);
            String quantity = request.getParameter("quantity");
            String bStream = request.getParameter("reporter");
            ...
            try {
                ...
                String query = "insert into book(name,quantity,bStream,bClass,auther,publisher) values('" + name + "','"+quantity+"','" + bStream + "','" + bClass + "','"+auther+"','"+publisher+"')";
                int a = stmt.executeUpdate(query);
                if(a>0){
                    out.println("<div class=\"panel-body\"><h1>Book added Successful</h1></div>");
                }else{
                    out.println("<div class=\"panel-body\"><h1>ERROR</h1></div>");
