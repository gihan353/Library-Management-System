	...
	<section class="">
		<div class="container">
			...
			<div class="col-md-6">
                ...
                while(rs.next()){
                    out.println("<option>"+rs.getString("id")+"</option>");
                    }
               }
                        catch(Exception e){
                        e.printStackTrace();
                ...
                <div class="col-md-12 offset_0 offset_1">
                	<button style="width: 100%;" type="submit" name="btnsave" class="btn btn-success">REMOVE BOOK</button>
                </div>
